        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="space-y-7 animate-slide-in-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20">
              ...
              <span className="text-sm text-blue-400 font-medium">Disponible pour collaboration</span>
            </div>
            ...
            <p className="text-[#94a3b8] text-base sm:text-lg max-w-lg leading-relaxed">
              ...
              avec une approche centrée sur l&apos;expérience utilisateur et la performance.
            </p>
          ...
          <div className="hidden lg:flex items-center justify-center relative animate-float">
            <div className="relative w-80 h-80">
              ...
              {/* Anneaux décoratifs - Couleur bleue */}
            ...
            <div className="absolute -bottom-4 -left-4 px-4 py-2 rounded-lg glass text-xs font-mono text-blue-300 animate-float border border-blue-500/20" style={{ animationDelay: "1s" }}>
              💻 5+ Projets
            </div>
          </div>
        </div>
